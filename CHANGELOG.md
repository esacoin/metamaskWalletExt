...
- Added preset network image avatars in the 'select a networki' pop-up ([#22643](https://github.com/MetaMask/metamask-extension/pull/22643))
...
- Separate the test networks from other networks in the "select a networki" popup ([#19812](https://github.com/MetaMask/metamask-extension/pull/19812))
